...
5. Review gate: once the PR is open, run the `code-review` skill on it, post the result as a comment on the PR, and stop. Do not merge. The squash merge and the tag remain human actions.
